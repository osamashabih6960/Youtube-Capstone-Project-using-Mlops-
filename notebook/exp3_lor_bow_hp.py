...
from sklearn.feature_extraction.ext import TfidfVectorizer
from sklearn.metrics import accuracy_score, precision_score, recall_score,f1_score
from nltk.corpus import syopwords
...
MLFLOW_TRACKING_URI =  "https://dagshub.com/osamashabih6960/Youtube-Capstone-Project-using-Mlops-.mlflow",
dagshub.init(repo_owner="osamashabih6960", repo_name="Youtube-Capstone-Project-using-Mlops-", mlflow=True)
